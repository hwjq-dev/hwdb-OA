...
const MultipleSelector = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          ' focus-within:ring-0 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive relative min-h-[38px] rounded-md border text-sm transition-[color,box-shadow] outline-none  has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50',
          {
      ...
      >
        <div className="flex flex-wrap gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              'flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed placeholder:text-dark',
              {
