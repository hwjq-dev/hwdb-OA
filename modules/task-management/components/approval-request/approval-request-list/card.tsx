...
import { Priority } from '../../base/task-list/priority';
import { TaskStatus } from '../../base/task-list/task-status';
import { ApproveRequestModal } from '../approval-request-modal';

export const ApprovalRequestCard: React.FC<TaskProps> = (props) => {
  const { tgId, title, subtitle, assignedAt, assignee, endAt, startAt, status, priority } = props;
