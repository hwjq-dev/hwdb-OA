...
export const ChangeDayoffRequestDetail = () => {
  return (
      ...
      <div className="relative rounded-2xl p-2 shadow-[0px_0px_23px_0px_rgba(0,_0,_0,_0.1)]">
        <div className="bg-white p-2 rounded-xl">
          ...
          <div className="[&>*]:pl-2 space-y-2 pt-5 pb-2">
            ...
            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">排休原时间</span>
              <span className="text-sm ml-1 col-span-2">{data.preShiftDate}</span>
            </p>

            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">调休后时间</span>
              <span className="text-sm ml-1 col-span-2">{data.newShiftDate}</span>
            </p>

            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">调休原因</span>
  ...
  return (
    <div className="relative rounded-2xl px-2 pb-2 pt-6 shadow-[0px_0px_23px_0px_rgba(0,_0,_0,_0.1)]">
      <div className="bg-white p-3 rounded-xl flex flex-col space-y-8">
        ...
        {/*-- step2 --*/}
        <Step type="主管" title="部门主管" subtitle={`利税 - 产品主管`} isApproved={false} />

        {/*-- step3 --*/}
        <Step type="人事" title="人事经理" subtitle="李明 - 人事经理" isApproved={false} />

        {/*-- step4 --*/}
        <Step type="经理" title="部门经理" subtitle="李敏 - 产品经理" isApproved={false} />
      </div>
    </div>
  );
};
