...
export const ApproveOvertimeDetail = () => {
  return (
        ...
        <div className="bg-white p-2 rounded-xl">
          <div className="flex space-x-3 items-center mt-1">
            ...
            <div>
              ...
              <p className={cn('text-xs text-yellow-500')}>{data.status}</p>
            </div>
          </div>
          ...
          <div className="[&>*]:pl-2 space-y-2 pt-5 pb-2">
            ...
            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">加班时长</span>
              <span className="text-sm ml-1 col-span-2">
            ...
            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">加班原因</span>
