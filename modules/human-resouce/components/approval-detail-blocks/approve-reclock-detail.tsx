...
const data = {
  ...
  absentTime: '上班时间',
  workShif: '早班',
  reclockTime: '2025-06-17T10:02:00+07:00',
  reason: '忘记打卡',
};

export const ReclockRequestDetail = () => {
  return (
      ...
      <div className="relative rounded-2xl p-2 shadow-[0px_0px_23px_0px_rgba(0,_0,_0,_0.1)]">
        <div className="bg-white p-2 rounded-xl">
          ...
          <div className="[&>*]:pl-2 space-y-2 pt-5 pb-2">
            ...
            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">补卡原因</span>
              <span className="text-sm ml-1 col-span-2">{data.reason}</span>
            </p>

            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">未补卡时间</span>
              <span className="text-sm ml-1 col-span-2">{data.absentTime}</span>
            </p>

            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">班次类型</span>
              <span className="text-sm ml-1 col-span-2">{data.workShif}</span>
            </p>

            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">补卡日期</span>
              <span className="text-sm ml-1 col-span-2">
                {getFormatDatetime(new Date(data.reclockTime))}
              </span>
            </p>
