...
const data = {
  ...
  lateDate: '2025-06-17T10:02:00+07:00',
  reason: '堵车很厉害',
};

export const LateRequestDetail = () => {
  return (
      ...
      <div className="relative rounded-2xl p-2 shadow-[0px_0px_23px_0px_rgba(0,_0,_0,_0.1)]">
        <div className="bg-white p-2 rounded-xl">
          ...
          <div className="[&>*]:pl-2 space-y-2 pt-5 pb-2">
            ...
            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">免迟到日期</span>
              <span className="text-sm ml-1 col-span-2">
                {getFormatDatetime(new Date(data.lateDate))}
              </span>
            </p>

            <p className="grid grid-cols-3 items-center">
              <span className="font-bold col-span-1 text-sm">免迟到原因</span>
